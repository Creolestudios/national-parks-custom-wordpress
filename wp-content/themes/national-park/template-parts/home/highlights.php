<?php
/**
 * Template for highlights section.
 */

$selected_post_ids = get_field( 'highlights', get_the_ID() );

if ( ! empty( $selected_post_ids ) && isset( $selected_post_ids ) ) {
	?>
		<div class="did-you-know-slider-wrapper">
			<h2 class="did-you-know-title">
				<img class="img-cover" src="<?php echo esc_url( NPX_THEME_URI . '/dist/assets/images/didyouknow-title.svg' ); ?>" alt="title" >
			</h2>
					...
					?>
						<div class="did-you-know-slider-item">
							<div class="did-you-know-slider-img-wrapper">
								...
								if ( ! empty( $post_image ) ) {
									?>
										<img class="img-cover" src="<?php echo esc_url( $post_image ); ?>" alt="<?php echo esc_attr( npx_get_img_alt( $post_id ) ); ?>" >
									<?php
								} else {
							...
							<div class="did-you-know-slider-content">
								...
								<a class="btn btn-lightsky" href="<?php echo esc_url( $post_url ); ?>">
