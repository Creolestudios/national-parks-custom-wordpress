...
$default_logo_url        = NPX_THEME_URI . '/dist/assets/images/Animalkingdomlogo.svg';
$default_founder_url     = NPX_THEME_URI . '/dist/assets/images/author-image.png';
	...
	<div class="aboutus-container">
					...
					?>
							<div class="most-amazing-animal">
								...
								<div class="most-amazing-animal-img-wrapper">
									...
									<div class="jagged modal-popup white" style="background-image: url(<?php echo esc_url($explore_cotent['image']); ?>)"> </div>
								</div>
							</div>
					<?php
						}
		...
		<div class="contact-us-newsletter-wrapper">
			<div class="contact-us-newsletter">
				<h3 class=""><?php echo esc_html($inquiry_label); ?></h3>
				<p class=""><?php echo wp_kses_post($inquiry_description); ?></p>
