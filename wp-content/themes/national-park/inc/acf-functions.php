 ...
 */
  ...
  * @version 1.0.0
  */
function npx_acf_json_save_point( $path ) {
	// Update path.
	$path = NPX_THEME_DIR . '/acf-json';

	// Return the updated path.
	return $path;
}
add_filter( 'acf/settings/save_json', 'npx_acf_json_save_point' );
 ...
 * @version 1.0.0
 */
function npx_acf_json_load_point( $paths ) {
...
add_filter( 'acf/settings/load_json', 'npx_acf_json_load_point' );
...
if ( function_exists( 'acf_add_options_page' ) ) {
	acf_add_options_page(
		[
			'page_title' => __( 'General Settings', 'npx' ),
			'menu_title' => __( 'General Settings', 'npx' ),
