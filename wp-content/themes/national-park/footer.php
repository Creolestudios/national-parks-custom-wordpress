...
$default_footer_logo = NPX_THEME_URI . '/dist/assets/images/NPA-stacked.png';
$footer_logo         = ! empty( get_field( 'footer_logo', 'option' ) ) ? get_field( 'footer_logo', 'option' ) : $default_footer_logo;
?>
	...
	<div class="container">
		<div class="footer-logo-wrapper">
			<a href="<?php echo esc_url( home_url() ); ?>">
				<img class="img-cover" src="<?php echo esc_url( $footer_logo ); ?>" alt="footer logo">
			</a>
		</div>
